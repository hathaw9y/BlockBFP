...
def evaluate_wikitext2_ppl(
    ...
    *,
    ...
    Uses the raw WikiText-2 text and a sliding window so tokens are scored with
    as much left context as the model supports.
    """
...
def main():
    ...
    if args.rotate:
        rotation_utils.fuse_lyaer_norms(model)
